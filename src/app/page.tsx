...
import { ArrowRight, FileUp, CheckCircle2, MessageCircleQuestion } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 space-y-8">
              ...
              <p className="text-lg text-secondary max-w-xl leading-relaxed">
                Modernisasi administrasi pemakaman yang mengedepankan penghormatan dan efisiensi. 
                Daftarkan dan kelola data makam dengan sentuhan teknologi modern.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center gap-4 px-6 py-4 bg-white/50 border border-slate-100 rounded-xl text-secondary text-sm">
                  ...
                  <span>Bingung prosedur? Tanya AI kami di pojok kanan bawah</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 hidden md:block">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-900 leading-none">Terverifikasi</p>
                    <p className="text-xs text-secondary mt-1">Sertifikasi Lahan Digital</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white border-y border-slate-100">
        <div className="container mx-auto px-4 lg:px-12 text-center">
          ...
          <p className="text-secondary mb-16 max-w-2xl mx-auto">Langkah-langkah sederhana untuk mendaftarkan lokasi peristirahatan terakhir yang layak bagi keluarga tercinta secara digital.</p>
        ...
        <div className="container mx-auto px-4 lg:px-12">
          <div className="bg-primary rounded-[3rem] p-12 lg:p-20 text-white flex flex-col lg:flex-row items-center gap-12 overflow-hidden relative">
            <div className="flex-1 space-y-8 relative z-10 text-center lg:text-left">
              <h2 className="text-5xl font-bold leading-tight">Butuh Bantuan Segera?</h2>
              <p className="text-primary-light text-lg">
                Asisten AI kami siap menjawab pertanyaan Anda mengenai regulasi, biaya, dan prosedur pemakaman kapan saja tanpa perlu login.
              </p>
              <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm px-8 py-4 rounded-2xl border border-white/20 animate-bounce">
                <span className="text-sm font-bold uppercase tracking-widest">Tanya Sekarang di Pojok Kanan Bawah</span>
                <ArrowRight size={20} />
              </div>
            </div>
...
function ProcessStep({ num, icon, title, description }: { num: string, icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="bg-white p-10 rounded-[2rem] border border-slate-100 hover:shadow-xl transition-all group text-left">
      <div className="mb-8 flex items-center justify-between">
        ...
        <span className="text-4xl font-extrabold text-slate-100 group-hover:text-slate-200 transition-colors">#{num}</span>
      </div>
