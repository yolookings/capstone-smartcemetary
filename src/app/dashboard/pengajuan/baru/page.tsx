...
export default function BaruPengajuanPage() {
  ...
  const handleEmailChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const value = e.target.value.toLowerCase().replace(/@gmail\.com$/, "");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const relationshipFinal =
        relationship === "Lainnya" && relationshipOther
          ? relationshipOther
          : relationship;
      ...
      if (res.ok) {
        showSnackbar({
          message:
            "Pengajuan berhasil dikirim! Memeriksa notifikasi WhatsApp Anda.",
          type: "success",
          duration: 5000,
        });
        setSuccess(true);
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/90 to-transparent flex flex-col justify-end p-8 text-white">
                ...
                <p className="text-sm opacity-80 leading-relaxed text-justify">
                  Lengkapi data untuk mendigitalisasi memori orang yang
                  tersayang ke dalam sebuah sistem administrasi pemakaman.
                </p>
              </div>
            </div>
          ...
          <form
            ...
            className="flex-1 space-y-8 bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-100"
          >
            {success && (
              <div className="bg-emerald-50 border border-emerald-200 text-emerald-600 px-6 py-4 rounded-2xl flex items-center gap-3">
                ...
                <p className="text-sm font-medium">
                  Pengajuan berhasil dikirim! Mengalihkan ke halaman status...
                </p>
              </div>
            )}
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-neutral rounded-full flex items-center justify-center font-bold text-primary">
                  1
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <FormGroup label="Nama Lengkap Almarhum/ah">
                  <input
                    type="text"
                    required
                    value={deceasedName}
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <FormGroup label="Email">
                  <div className="flex items-stretch">
                    <input
                      ...
                      className="input-field flex-1 !rounded-r-none rounded-l-xl border-r-0"
                      placeholder="nama"
                    />
                    <span className="flex items-center px-4 bg-slate-100 border border-slate-300 !rounded-l-none rounded-r-xl text-slate-600 text-sm font-medium whitespace-nowrap">
                      @gmail.com
                    </span>
                  </div>
                </FormGroup>
                ...
                <FormGroup label="Nomor WhatsApp">
                  <div className="flex items-stretch">
                    <span className="flex items-center px-4 bg-slate-100 border border-slate-300 !rounded-r-none rounded-l-xl text-slate-600 text-sm font-medium">
                      +62
                    </span>
                    <input
                      type="tel"
                      ...
                      className="input-field flex-1 !rounded-l-none rounded-r-xl border-l-0"
            ...
            <div className="pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-6">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-xs text-secondary leading-tight">
                  Saya menyatakan bahwa data yang saya kirimkan adalah benar dan
...
function RequirementItem({ text }: { text: string }) {
  return (
    <li className="flex items-center gap-3 text-slate-600 text-xs">
